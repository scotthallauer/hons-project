...
public class SingleObjectiveEAWorker implements Callable<Object>  {
     ...
     * The parent object.
     */
    private final SingleObjectiveEA train;
     ...
     *            The species.
     */
    public SingleObjectiveEAWorker(final SingleObjectiveEA theTrain, final Species theSpecies) {
        this.train = theTrain;
