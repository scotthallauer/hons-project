...
public class MaximisingObjectiveComparator<T extends MultiObjectiveGenome> implements Comparator<T>
{

    private int objectiveIndex;

    public MaximisingObjectiveComparator() {
    ...
    {
        double o1Value = o1.getScoreVector().get(objectiveIndex);
        double o2Value = o2.getScoreVector().get(objectiveIndex);
