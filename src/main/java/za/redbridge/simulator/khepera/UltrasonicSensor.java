...
public class UltrasonicSensor extends AgentSensor {
    ...
    public static final float ULTRASONIC_SENSOR_MAX_RANGE = 4.0f; // 4 meters
    public static final float ULTRASONIC_SENSOR_MIN_RANGE = 0.2f; // 20 centimeters
    public static final float ULTRASONIC_SENSOR_FOV = 1.22f; // 35 degrees
