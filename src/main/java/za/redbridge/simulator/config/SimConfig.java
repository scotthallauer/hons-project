...
public class SimConfig extends Config
{
    ...
    public SimConfig(String filepath)
    {
        ...
        if (checkFieldPresent(bots, "robots"))
        {
            ...
            Double minDistBtwnSensors2 = (Double) bots.get("minDistBetweenSensors");
            if (checkFieldPresent(minDistBtwnSensors2, "robots:minDistBetweenSensors"))
            {
                minDistBtwnSensors = minDistBtwnSensors2;
            }
